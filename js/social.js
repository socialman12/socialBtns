...
var SocialShareKit = (function () {
    ...
    function getUrl(options, network, el) {
        var url, dataOpts = getDataOpts(options, network, el),
            ...
            shareUrlEnc = encodeURIComponent(document.referrer),
    ...
    function addCount(el, cnt) {
		if(el.childElementCount > 0){
			el.childNodes[0].innerHTML = el.childNodes[0].innerHTML + cnt;
		} else {
	...
	function getOurCount(network, shareUrl, onReady){
    ...
    function getCount(network, shareUrl, onReady) {
		getOurCount(network, shareUrl, onReady);
        var url, parseFunc, body,
            shareUrlEnc = encodeURIComponent(window.name);
        switch (network) {
            case 'facebook':
                url = 'https://graph.facebook.com/?id=' + shareUrlEnc;
                parseFunc = function (r) {
